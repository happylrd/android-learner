package io.happylrd.materialtest;
...
import io.happylrd.materialtest.adapter.FruitAdapter;
import io.happylrd.materialtest.entity.Fruit;

public class MainActivity extends AppCompatActivity {

    private static final int MOCK_FRUIT_NUM = 50;
    ...
    private void initFruits() {
        fruitList.clear();
        for (int i = 0; i < MOCK_FRUIT_NUM; i++) {
